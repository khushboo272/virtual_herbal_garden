...
export function UserDashboard({ savedPlants }: UserDashboardProps) {
  const recentlyViewed = savedPlants.slice(0, 3);
  
  const stats = [
    { label: "Plants Explored", value: "47", icon: Leaf, color: "bg-green-100 text-green-700" },
    { label: "Tours Completed", value: "3", icon: Award, color: "bg-emerald-100 text-emerald-700" },
    { label: "Learning Hours", value: "12.5", icon: Clock, color: "bg-teal-100 text-teal-700" },
    { label: "Achievements", value: "8", icon: TrendingUp, color: "bg-lime-100 text-lime-700" },
  ];

  const achievements = [
    { title: "First Steps", description: "Completed your first tour", earned: true },
    { title: "Plant Explorer", description: "Viewed 25+ plants", earned: true },
    { title: "Knowledge Seeker", description: "Spent 10+ hours learning", earned: true },
    { title: "Master Herbalist", description: "Complete all tours", earned: false },
  ];

  const learningProgress = [
    { category: "Immunity Plants", progress: 85, plants: 17 },
    { category: "Digestive Herbs", progress: 60, plants: 12 },
    { category: "Skin Care", progress: 45, plants: 9 },
    { category: "Respiratory", progress: 30, plants: 6 },
  ];
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl text-green-900 mb-1">Welcome back, John!</h1>
            ...
            <Card className="border-2 border-green-200 bg-white">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {savedPlants.slice(0, 4).map((plant) => (
                    <Card 
                      key={plant.id}
                      ...
                      <CardContent className="p-0">
                        <div className="flex items-center gap-3 p-4">
                          ...
                          <div className="flex-1">
                            <h4 className="text-sm text-green-900 mb-1">{plant.name}</h4>
                            <p className="text-xs text-green-600">Saved {plant.savedDate}</p>
                          </div>
                ...
                <div className="space-y-3">
                  {recentlyViewed.map((plant) => (
                    ...
                    >
                      ...
                      />
                      <div className="flex-1">
                        <h4 className="text-sm text-green-900">{plant.name}</h4>
