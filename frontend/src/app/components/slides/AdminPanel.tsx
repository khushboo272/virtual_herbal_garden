...
export function AdminPanel() {
  ...
  const stats = [
    { label: "Total Plants", value: String(apiStats?.totalPlants ?? 0), change: "+12", icon: BarChart2, color: "bg-green-100 text-green-700" },
    { label: "Active Users", value: String(apiStats?.totalUsers ?? 0), change: "+89", icon: Users, color: "bg-blue-100 text-blue-700" },
    { label: "Total Views", value: String(apiStats?.totalViews ?? 0), change: "+2.4K", icon: Eye, color: "bg-purple-100 text-purple-700" },
