...
export function FallbackPlant({ position, color = '#2d7a3a' }: FallbackPlantProps) {
  ...
  return (
    <group ref={groupRef} position={position}>
      ...
      <mesh castShadow={!isMobile} position={[-0.28, 1.4, -0.18]}>
